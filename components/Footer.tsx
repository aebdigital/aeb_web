...
export function Footer() {
  ...
  return (
                <footer className="footer bg-black text-white pt-12 pb-20 relative overflow-hidden">
                  <div className="footer-gradient absolute inset-0 z-0"></div> {/* Placeholder for gradient if any */}              <div className="container relative z-10">
