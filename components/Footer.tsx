      ...
      <div className="container relative z-10">
        <div className="footer-content grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="footer-main md:col-span-1">
            <div className="footer-brand mb-6">
              ...
              <p className="text-gray-light text-base mb-6 max-w-sm">Wir entwickeln digitale Lösungen für Ihren Erfolg. Moderne Websites, Anwendungen und maßgeschneidertes Marketing.</p>
          ...
          <div className="footer-links grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:col-span-3">
            <div className="footer-column">
              <h4 className="text-xl">Unternehmen</h4>
              <ul>
                <li className="mb-2"><Link href="/about" className="text-gray-light hover:text-primary-purple transition-colors text-base">Über uns</Link></li>
            ...
            <div className="footer-column">
              <h4 className="text-xl">Dienstleistungen</h4>
              <ul>
                ...
                <li className="mb-2"><Link href="/services#web-applications" className="text-gray-light hover:text-primary-purple transition-colors text-base">Webanwendungen</Link></li>
                ...
                <li className="mb-2"><Link href="/services#digital-marketing" className="text-gray-light hover:text-primary-purple transition-colors text-base">Digitales Marketing</Link></li>
                <li className="mb-2"><Link href="/services#email-marketing" className="text-gray-light hover:text-primary-purple transition-colors text-base">E-Mail-Marketing</Link></li>
              </ul>
            </div>
        ...
        <div className="footer-bottom flex flex-col md:flex-row justify-between items-center mt-12 pt-6 border-t border-white/[0.1] text-base">
          ...
          <div className="footer-legal flex space-x-4">
            <Link href="/privacy-policy" className="text-gray-light hover:text-primary-purple transition-colors text-base">Datenschutz</Link>
            <a href="#" id="cookie-settings-footer" className="cookie-settings-icon text-gray-light hover:text-primary-purple transition-colors flex items-center text-base" title="Cookie Einstellungen" onClick={handleCookieSettingsClick}>
