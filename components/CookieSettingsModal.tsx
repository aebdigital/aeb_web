  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-3xl font-bold mb-6">Cookie-Einstellungen</h3>
        ...
        <div className="cookie-category mb-6">
          <div className="cookie-category-header flex justify-between items-center mb-2">
            <label className="cookie-switch relative inline-flex items-center cursor-pointer">
              ...
              <span className="ml-3 text-lg font-semibold text-white">Notwendige Cookies</span>
            </label>
          </div>
          <p className="text-gray-light text-sm">Diese Cookies sind für die Grundfunktionen der Website erforderlich und können nicht deaktiviert werden.</p>
        </div>
        ...
        <div className="cookie-category mb-6">
          <div className="cookie-category-header flex justify-between items-center mb-2">
            <label className="cookie-switch relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="relative w-11 h-6 bg-gray-700 rounded-full peer peer-checked:bg-accent-teal after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-full"></div>
              <span className="ml-3 text-lg font-semibold text-white">Analyse-Cookies</span>
            </label>
          </div>
          <p className="text-gray-light text-sm">Sie helfen uns zu verstehen, wie Besucher unsere Website nutzen, damit wir sie verbessern können.</p>
        </div>
        ...
        <div className="cookie-category mb-6">
          ...
          <p className="text-gray-light text-sm">Sie werden verwendet, um Anzeigen zu personalisieren und deren Wirksamkeit zu messen.</p>
        </div>

        <div className="cookie-settings-buttons flex flex-col md:flex-row gap-4 mt-8">
          <button onClick={handleSaveSettings} className="btn btn-primary flex-1">Einstellungen speichern</button>
          <button onClick={handleAcceptAll} className="btn btn-primary flex-1">Alle akzeptieren</button>
        </div>
      </div>
    </div>
  );
