...
const allBlogPosts: BlogPostData[] = [
  {
    ...
    metadata: {
      ...
      ogImage: "/sources/techstack/shopify-bag-icon-symbol-logo-701751695132537nenecmhs0u-removebg-preview-e1750440978862.png",
  ...
  },
  {
    ...
    metadata: {
      ...
      ogImage: "/sources/techstack/JavaScript-Logo-scaled-e1750439290173.png",
...
worker.onmessage = (e) => console.log('Result:', e.data);</code></pre>
  ...
  },
  {
    ...
    metadata: {
      ...
      ogImage: "/sources/techstack/React-icon.svg.png",
...
return <article>{post.content}</article>;
  ...
  },
  {
    ...
    metadata: {
      ...
      ogImage: "/sources/techstack/apps-figma-icon-2048x2048-ctjj5ab7.png",
  ...
  },
  {
    ...
    metadata: {
      ...
      ogImage: "/sources/techstack/HTML5_logo_and_wordmark.svg.png",
